        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-1">
            <a href="#" className="inline-block mb-4">
              <span className="text-xl font-semibold">Pristine</span>
            </a>
            <p className="text-muted-foreground mb-4 max-w-xs">
              Designing products that blend form and function to create meaningful experiences.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Watches</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">Headphones</a></li>
        ...
        <div className="pt-10 mt-10 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-muted-foreground text-sm">
              © {currentYear} Pristine. All rights reserved.
            </p>
